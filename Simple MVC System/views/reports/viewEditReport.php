                ...
                <div class="col-md-6">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary"><?= $lang->getTxt($idPage, "header-edit-report"); ?></h6>
                        </div>
                        <div class="card-body">
                            <div class="form-row justify-content-center">
                                <div class="col-md-10 mb-3 mt-1">
                                    <input type="text" name="title" class="form-control <?php if(isset($_SESSION['inputResponseTitle']) && !empty($_SESSION['inputResponseTitle'])){ echo htmlspecialchars($_SESSION['inputResponseTitle'], ENT_QUOTES); } ?>" value="<?php if(isset($_SESSION['inputValueTitle']) && !empty($_SESSION['inputValueTitle'])){ echo htmlspecialchars($_SESSION['inputValueTitle'], ENT_QUOTES); $_SESSION['inputValueTitle'] = ''; } else { echo $report->title(); } ?>" id="title" placeholder="<?= $lang->getTxt($idPage, "title-placeholder"); ?>">
                            ...
                            <div class="form-row justify-content-center">
                                <div class="col-md-10 mb-3 mt-1">
                                    <input type="text" name="identifiant" class="form-control <?php if(isset($_SESSION['inputResponseIdentifiant']) && !empty($_SESSION['inputResponseIdentifiant'])){ echo htmlspecialchars($_SESSION['inputResponseIdentifiant'], ENT_QUOTES); } ?>" value="<?php if(isset($_SESSION['inputValueIdentifiant']) && !empty($_SESSION['inputValueIdentifiant'])){ echo htmlspecialchars($_SESSION['inputValueIdentifiant'], ENT_QUOTES); $_SESSION['inputValueIdentifiant'] = ''; } else { echo $report->identifiant(); } ?>" id="identifiant" placeholder="<?= $lang->getTxt($idPage, "identifiant-placeholder"); ?>">
                                    <!-- == If validation failed == -->
                            ...
                            <div class="form-row justify-content-center">
                                <div class="col-md-10 mb-3 mt-2">
                                    <input type="text" name="date" id="datepicker" data-toggle="datepicker" class="form-control <?php if(isset($_SESSION['inputResponseDate']) && !empty($_SESSION['inputResponseDate'])){ echo htmlspecialchars($_SESSION['inputResponseDate'], ENT_QUOTES); } ?>" placeholder="<?= $lang->getTxt($idPage, "date-placeholder"); ?>" value="<?php if(isset($_SESSION['inputValueDate']) && !empty($_SESSION['inputValueDate'])){ echo htmlspecialchars($_SESSION['inputValueDate'], ENT_QUOTES); $_SESSION['inputValueDate'] = ''; } else { if($report->date() != NULL) { $date = strtotime($report->date()); $date = date('d/m/Y', $date); echo $date; } else { echo $report->date(); }} ?>">
                                    <!-- == If validation failed == -->
                            ...
                            <div class="form-row justify-content-center">
                                <div class="col-md-10 mb-3 mt-2">
                                    <input type="text" name="severity" id="severity" class="form-control <?php if(isset($_SESSION['inputResponseSeverity']) && !empty($_SESSION['inputResponseSeverity'])){ echo htmlspecialchars($_SESSION['inputResponseSeverity'], ENT_QUOTES); } ?>" placeholder="<?= $lang->getTxt($idPage, "severity-placeholder"); ?>" value="<?php if(isset($_SESSION['inputValueSeverity']) && !empty($_SESSION['inputValueSeverity'])){ echo htmlspecialchars($_SESSION['inputValueSeverity'], ENT_QUOTES); $_SESSION['inputValueSeverity'] = ''; } else { echo $report->severity(); } ?>">
                                    <!-- == If validation failed == -->
                            ...
                            <div class="form-row justify-content-center">
                                <div class="col-md-10 mb-3 mt-2">
                                    <input type="text" name="endpoint" id="endpoint" class="form-control <?php if(isset($_SESSION['inputResponseEndpoint']) && !empty($_SESSION['inputResponseEndpoint'])){ echo htmlspecialchars($_SESSION['inputResponseEndpoint'], ENT_QUOTES); } ?>" placeholder="<?= $lang->getTxt($idPage, "endpoint-placeholder"); ?>" value="<?php if(isset($_SESSION['inputValueEndpoint']) && !empty($_SESSION['inputValueEndpoint'])){ echo htmlspecialchars($_SESSION['inputValueEndpoint'], ENT_QUOTES); $_SESSION['inputValueEndpoint'] = ''; } else { echo $report->endpoint(); } ?>">
                                    <!-- == If validation failed == -->
                                ...
                                <div class="col-md-10 mb-3 mt-2">
                                    <select class="form-control <?php if(isset($_SESSION['inputResponseProgram']) && !empty($_SESSION['inputResponseProgram'])){ echo htmlspecialchars($_SESSION['inputResponseProgram'], ENT_QUOTES); } ?>" id="program" name="program">
                                        ...
                                        <?php foreach($programs as $program): ?>
                                            <option value="<?= $program->id(); ?>" <?php if($program->id() == $report->programid()){ echo 'selected'; } ?>><?= $program->name(); ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                    <!-- == If validation failed == -->
                    ...
                    <div class="card cm shadow mb-4">
                        ...
                        <div class="card-body">
                            <div id="ressources" class="w-100">
                                <textarea style="display:none;" name="ressources"><?php if(isset($_SESSION['inputValueRessources']) && !empty($_SESSION['inputValueRessources'])){ echo htmlspecialchars_decode($_SESSION['inputValueRessources'], ENT_QUOTES); $_SESSION['inputValueRessources'] = ''; } else { echo $report->resources(); } ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card cm shadow mb-4">
                        ...
                        <div class="card-body">
                            <div id="impact" class="w-100">
                                <textarea style="display:none;" name="impact"><?php if(isset($_SESSION['inputValueImpact']) && !empty($_SESSION['inputValueImpact'])){ echo htmlspecialchars_decode($_SESSION['inputValueImpact'], ENT_QUOTES); $_SESSION['inputValueImpact'] = ''; } else { echo $report->impact(); } ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card cm shadow mb-4">
                        ...
                        <div class="card-body">
                            <div id="stepstoreproduce" class="w-100">
                                <textarea style="display:none;" name="stepstoreproduce"><?php if(isset($_SESSION['inputValueStepstoreproduce']) && !empty($_SESSION['inputValueStepstoreproduce'])){ echo htmlspecialchars_decode($_SESSION['inputValueStepstoreproduce'], ENT_QUOTES); $_SESSION['inputValueStepstoreproduce'] = ''; } else { echo $report->stepstoreproduce(); } ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card cm shadow mb-4">
                        ...
                        <div class="card-body">
                            <div id="mitigation" class="w-100">
                                <textarea style="display:none;" name="mitigation"><?php if(isset($_SESSION['inputValueMitigation']) && !empty($_SESSION['inputValueMitigation'])){ echo htmlspecialchars_decode($_SESSION['inputValueMitigation'], ENT_QUOTES); $_SESSION['inputValueMitigation'] = ''; } else { echo $report->mitigation(); } ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
